...
order never matters. The command is named `tally`, for the split tally stick —
the twelfth century's distributed, two-party, checksummed ledger. Notch the
...
*abelian* is the group. *tally* is the stick: the stock stays with the
